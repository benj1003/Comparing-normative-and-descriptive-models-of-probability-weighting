...
#z_lml = read_output('model_comparison_CPT_Gamble_2.mat','model_comparisson')
...
intensities = z_choices_subject_cpt #+ z_choices_subject_cpt
#Heatmap
labels = ['CPT','LML']
cmap = plt.get_cmap('binary')
fig, ax = plt.subplots()
plot = ax.pcolormesh(range(len(labels)+1), range(50), intensities, cmap=cmap)
